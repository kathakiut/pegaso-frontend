            ...
            <div className="px-3 py-3 text-bg-dark">
                <div className="container">
                    <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        <a href="/Inicio" className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                        ...
                        <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                            ...
                            <li>
                                <a href="/Tickets" className="nav-link text-white">
                            ...
                            <li>
                                <a href="/Agentes" className="nav-link text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-person-badge-fill d-block mx-auto mb-1" viewBox="0 0 16 16">
                            ...
                            <li>
                                <a href="/Registro" className="nav-link text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi d-block mx-auto mb-1" viewBox="0 0 16 16">
                            ...
                            <li>
                                <a href="/Ingreso" class="nav-link text-white">
